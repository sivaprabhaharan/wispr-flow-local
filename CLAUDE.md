...
**YOU ARE IN: `wispr_flow_local/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/wispr_flow_local/` (rig root) or other directories
...
**Your mail address:** `wispr_flow_local/polecats/obsidian`
**Your rig:** wispr_flow_local
**Your Witness:** `wispr_flow_local/witness`
...
| Ask Witness for help | `gt mail send wispr_flow_local/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`wispr_flow_local/witness`) when:
...
```bash
gt mail send wispr_flow_local/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
